    ...
    >
      ...
      <div style={{ position: 'relative', zIndex: 2, maxWidth: '680px' }}>
        ...
        >
          ...
          <span
            style={{
              ...
              display: 'block',
              lineHeight: 1,
              textShadow: '0 0 40px rgba(204,0,170,0.5)',
              opacity: 0,
              animation: 'fadeUp 0.6s ease forwards 0.7s, glitch 8s step-end infinite 2s',
            }}
          >
            &amp;
          </span>
        ...
        >
          ...
          >
            <span style={{ fontFamily: 'var(--font-cacha)', fontSize: '14px', letterSpacing: '1px', textTransform: 'uppercase', color: '#00d4c8' }}>
              {t.hero.cta1Label}
            </span>
