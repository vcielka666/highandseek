...
const ProductSchema = new mongoose.Schema({
  ...
  strain: {
    ...
    cbn:            { type: String, default: '' },
  },
  description:      { type: String, required: true },
  shortDescription: { type: String, required: true, maxlength: 100 },
  descriptionCs:      { type: String, default: '' },
  shortDescriptionCs: { type: String, default: '' },
  price:            { type: Number, required: true, min: 0 },
  stock:            { type: Number, required: true, default: 0 },
  images:           [{ type: String }],
  tags:             [{ type: String }],
  variants:         [{ label: { type: String, required: true }, price: { type: Number, required: true } }],
